...
export class FormResponse { private constructor(); readonly cancelationReason?: FormCancelationReason; readonly canceled: number}
...
export class ModalFormData { constructor(); dropdown(label: _10.RawMessage | string, options: _10.RawMessage | string[], defaultValueIndex?: number): ModalFormData; show(player: _10.Player): Promise<ModalFormResponse>; slider(label: _10.RawMessage | string, minimumValue: number, maximumValue: number, valueStep: number, defaultValue?: number): ModalFormData; textField(label: _10.RawMessage | string, placeholderText: _10.RawMessage | string, defaultValue?: _10.RawMessage | string): ModalFormData; title(titleText: _10.RawMessage | string): ModalFormData; toggle(label: _10.RawMessage | string, defaultValue?: number): ModalFormData}
//@ts-ignore allow class inheritance for native classes
export class ModalFormResponse extends FormResponse{ private constructor(); readonly formValues?: number | number | string[]}
