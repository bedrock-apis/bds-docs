...
export class DebugArrow extends DebugLine {
   ...
   public constructor(location: server.Vector3, endLocation: server.Vector3);
}
//@ts-ignore
export class DebugBox extends DebugShape {
   public bound: server.Vector3;
   public constructor(location: server.Vector3);
}
//@ts-ignore
...
export class DebugDrawer {
   public addShape(shape: DebugShape): void;
...
export class DebugText extends DebugShape {
   public text: string;
   public constructor(location: server.Vector3, text: string);
}
