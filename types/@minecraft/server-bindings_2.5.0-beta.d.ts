...
export interface BlockFilter {
   excludePermutations?: Array<BlockPermutation>;
   excludeTags?: Array<string>;
   excludeTypes?: Array<string>;
   includePermutations?: Array<BlockPermutation>;
...
export interface EntityFilter {
   ...
   name?: string;
   propertyOptions?: Array<EntityQueryPropertyOptions>;
...
export interface TitleDisplayOptions {
   ...
   stayDuration: number;
   subtitle?: Array<RawMessage | string> | RawMessage | string;
}
...
export class Block {
   ...
   public above(steps?: number): (Block | undefined);
   public below(steps?: number): (Block | undefined);
...
export class BlockComponentPlayerPlaceBeforeEvent extends BlockEvent {
   ...
   public readonly face: Direction;
   public permutationToPlace: BlockPermutation;
   public readonly player?: Player;
   private constructor();
}
//@ts-ignore
...
export class BlockComponentRegistry {
   public registerCustomComponent(name: string, customComponent: BlockCustomComponent): void;
   private constructor();
}
//@ts-ignore
...
export class BlockExplodeAfterEvent extends BlockEvent {
   public readonly explodedBlockPermutation: BlockPermutation;
   public readonly source?: Entity;
   private constructor();
}
export class BlockExplodeAfterEventSignal {
   public subscribe(callback: (arg0: BlockExplodeAfterEvent)=>void): (arg0: BlockExplodeAfterEvent)=>void;
   public unsubscribe(callback: (arg0: BlockExplodeAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
export class BlockFluidContainerComponent extends BlockComponent {
   public static readonly componentId = "minecraft:fluid_container";
   public fillLevel: number;
   public fluidColor: RGBA;
   public addDye(dye: ItemType): void;
   public getFluidType(): FluidType;
   public setFluidType(fluidType: FluidType): void;
   public setPotion(itemStack: ItemStack): void;
   private constructor();
}
//@ts-ignore
...
export class BlockMapColorComponent extends BlockComponent {
   public static readonly componentId = "minecraft:map_color";
   public readonly color: RGBA;
   public readonly tintedColor: RGBA;
   public readonly tintMethod: TintMethod;
   private constructor();
}
//@ts-ignore
export class BlockMovableComponent extends BlockComponent {
   public static readonly componentId = "minecraft:movable";
   public readonly movementType: MovementType;
   public readonly stickyType: StickyType;
   private constructor();
}
export class BlockPermutation {
   ...
   public getState(stateName: string): (boolean | number | string | undefined);
   public getTags(): Array<string>;
   public hasTag(tag: string): boolean;
   public isLiquidBlocking(liquidType: LiquidType): boolean;
   public liquidSpreadCausesSpawn(liquidType: LiquidType): boolean;
   ...
   public withState(name: string, value: boolean | number | string): BlockPermutation;
   private constructor();
}
//@ts-ignore
export class BlockPistonComponent extends BlockComponent {
   public static readonly componentId = "minecraft:piston";
   public readonly isMoving: boolean;
   public readonly state: BlockPistonState;
   public getAttachedBlocks(): Array<Block>;
   public getAttachedBlocksLocations(): Array<Vector3>;
   private constructor();
}
//@ts-ignore
...
export class BlockRecordPlayerComponent extends BlockComponent {
   ...
   public getRecord(): (ItemStack | undefined);
   public isPlaying(): boolean;
   public pauseRecord(): void;
   public playRecord(): void;
   public setRecord(recordItemType?: ItemType | string, startPlaying?: boolean): void;
   private constructor();
}
//@ts-ignore
export class BlockRedstoneProducerComponent extends BlockComponent {
   public static readonly componentId = "minecraft:redstone_producer";
   public readonly power: number;
   public getConnectedFaces(): Array<Direction>;
   public getStronglyPoweredFace(): (Direction | undefined);
   private constructor();
}
//@ts-ignore
export class BlockSignComponent extends BlockComponent {
   public static readonly componentId = "minecraft:sign";
   public readonly isWaxed: boolean;
   public getRawText(side?: SignSide): (RawText | undefined);
   public getText(side?: SignSide): (string | undefined);
   public getTextDyeColor(side?: SignSide): (DyeColor | undefined);
   public setText(message: RawMessage | string, side?: SignSide): void;
   public setTextDyeColor(color?: DyeColor, side?: SignSide): void;
   public setWaxed(waxed: boolean): void;
   private constructor();
}
export class BlockStates {
   public static get(stateName: string): (BlockStateType | undefined);
   public static getAll(): Array<BlockStateType>;
   private constructor();
}
export class BlockStateType {
   public readonly id: string;
   public readonly validValues: Array<boolean | number | string>;
   private constructor();
}
...
export class BlockVolume extends BlockVolumeBase {
   ...
   public doesLocationTouchFaces(pos: Vector3): boolean;
   public doesVolumeTouchFaces(other: BlockVolume): boolean;
   public intersects(other: BlockVolume): BlockVolumeIntersection;
}
export class BlockVolumeBase {
   ...
   public isInside(location: Vector3): boolean;
...
export class ButtonPushAfterEventSignal {
   public subscribe(callback: (arg0: ButtonPushAfterEvent)=>void): (arg0: ButtonPushAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ButtonPushAfterEvent)=>void): void;
   private constructor();
}
export class Camera {
   public readonly isValid: boolean;
...
export class Container {
   ...
   public find(itemStack: ItemStack): (number | undefined);
   public findLast(itemStack: ItemStack): (number | undefined);
   public firstEmptySlot(): (number | undefined);
   public firstItem(): (number | undefined);
...
export class ContainerSlot {
   ...
   public lockMode: ItemLockMode;
   public readonly maxAmount: number;
   public nameTag?: string;
   public readonly type: ItemType;
   public readonly typeId: string;
   public clearDynamicProperties(): void;
   public getCanDestroy(): Array<string>;
   public getCanPlaceOn(): Array<string>;
   public getDynamicProperty(identifier: string): (boolean | number | number | string | Vector3 | undefined);
   public getDynamicPropertyIds(): Array<string>;
   public getDynamicPropertyTotalByteCount(): number;
   public getItem(): (ItemStack | undefined);
   public getLore(): Array<string>;
   public getRawLore(): Array<RawMessage>;
   public getTags(): Array<string>;
   public hasItem(): boolean;
   public hasTag(tag: string): boolean;
   public isStackableWith(itemStack: ItemStack): boolean;
   public setCanDestroy(blockIdentifiers?: Array<string>): void;
   public setCanPlaceOn(blockIdentifiers?: Array<string>): void;
   public setDynamicProperties(values: Record<string,boolean | number | number | string | Vector3 | undefined>): void;
   public setDynamicProperty(identifier: string, value?: boolean | number | number | string | Vector3): void;
   public setItem(itemStack?: ItemStack): void;
   public setLore(loreList?: Array<RawMessage | string>): void;
   private constructor();
}
export class CustomCommandOrigin {
   public readonly initiator?: Entity;
   public readonly sourceBlock?: Block;
   public readonly sourceEntity?: Entity;
   public readonly sourceType: CustomCommandSource;
   private constructor();
}
export class CustomCommandRegistry {
   public registerCommand(customCommand: CustomCommand, callback: ()=>(CustomCommandResult | undefined)): void;
   public registerEnum(name: string, values: Array<string>): void;
   private constructor();
}
...
export class DataDrivenEntityTriggerAfterEventSignal {
   public subscribe(callback: (arg0: DataDrivenEntityTriggerAfterEvent)=>void, options?: EntityDataDrivenTriggerEventOptions): (arg0: DataDrivenEntityTriggerAfterEvent)=>void;
   public unsubscribe(callback: (arg0: DataDrivenEntityTriggerAfterEvent)=>void): void;
   private constructor();
}
...
export class DimensionTypes {
   public static get(dimensionTypeId: string): (DimensionType | undefined);
...
export class EffectAddAfterEventSignal {
   public subscribe(callback: (arg0: EffectAddAfterEvent)=>void, options?: EntityEventOptions): (arg0: EffectAddAfterEvent)=>void;
   public unsubscribe(callback: (arg0: EffectAddAfterEvent)=>void): void;
   private constructor();
}
...
export class EffectAddBeforeEventSignal {
   public subscribe(callback: (arg0: EffectAddBeforeEvent)=>void): (arg0: EffectAddBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: EffectAddBeforeEvent)=>void): void;
   private constructor();
}
...
export class EffectTypes {
   public static get(identifier: string): (EffectType | undefined);
   public static getAll(): Array<EffectType>;
   private constructor();
}
//@ts-ignore
...
export class EnchantInfo {
   public readonly enchantment: string;
   public readonly range: common.NumberRange;
   private constructor();
}
export class EnchantmentType {
   public readonly id: string;
   public readonly maxLevel: number;
   public constructor(enchantmentType: string);
}
export class EnchantmentTypes {
   public static get(enchantmentId: string): (EnchantmentType | undefined);
   public static getAll(): Array<EnchantmentType>;
   private constructor();
}
//@ts-ignore
...
export class EnchantRandomlyFunction extends LootItemFunction {
   public readonly treasure: boolean;
   private constructor();
}
//@ts-ignore
export class EnchantWithLevelsFunction extends LootItemFunction {
   public readonly levels: common.NumberRange;
   public readonly treasure: boolean;
   private constructor();
}
export class Entity {
   ...
   public readonly isOnGround: boolean;
   public readonly isSleeping: boolean;
   public isSneaking: boolean;
   public readonly isSprinting: boolean;
   public readonly isSwimming: boolean;
   public readonly isValid: boolean;
   public readonly localizationKey: string;
   public readonly location: Vector3;
   public nameTag: string;
   ...
   public applyKnockback(horizontalForce: VectorXZ, verticalStrength: number): void;
   public clearDynamicProperties(): void;
   public clearVelocity(): void;
   public extinguishFire(useEffects?: boolean): boolean;
   public getAABB(): AABB;
   public getAllBlocksStandingOn(options?: GetBlocksStandingOnOptions): Array<Block>;
   public getBlockFromViewDirection(options?: BlockRaycastOptions): (BlockRaycastHit | undefined);
   public getBlockStandingOn(options?: GetBlocksStandingOnOptions): (Block | undefined);
   public getComponent(componentId: string): (EntityComponent | undefined);
   public getComponents(): Array<EntityComponent>;
   public getDynamicProperty(identifier: string): (boolean | number | number | string | Vector3 | undefined);
   public getDynamicPropertyIds(): Array<string>;
   public getDynamicPropertyTotalByteCount(): number;
   public getEffect(effectType: EffectType | string): (Effect | undefined);
   public getEffects(): Array<Effect>;
   public getEntitiesFromViewDirection(options?: EntityRaycastOptions): Array<EntityRaycastHit>;
   public getHeadLocation(): Vector3;
   public getProperty(identifier: string): (boolean | number | string | undefined);
   ...
   public hasTag(tag: string): boolean;
   public kill(): boolean;
   public lookAt(targetLocation: Vector3): void;
   ...
   public remove(): void;
   public removeEffect(effectType: EffectType | string): boolean;
   public removeTag(tag: string): boolean;
   public resetProperty(identifier: string): (boolean | number | string);
   public runCommand(commandString: string): CommandResult;
   public setDynamicProperties(values: Record<string,boolean | number | number | string | Vector3 | undefined>): void;
   public setDynamicProperty(identifier: string, value?: boolean | number | number | string | Vector3): void;
   public setOnFire(seconds: number, useEffects?: boolean): boolean;
   public setProperty(identifier: string, value: boolean | number | string): void;
   public setRotation(rotation: Vector2): void;
   public teleport(location: Vector3, teleportOptions?: TeleportOptions): void;
...
export class EntityAddRiderComponent extends EntityComponent {
   public static readonly componentId = "minecraft:addrider";
   public readonly entityType: string;
...
export class EntityAgeableComponent extends EntityComponent {
   public static readonly componentId = "minecraft:ageable";
   public readonly duration: number;
   public readonly growUp: Trigger;
   public readonly transformToItem: string;
   public getDropItems(): Array<string>;
   public getFeedItems(): Array<EntityDefinitionFeedItem>;
   private constructor();
}
//@ts-ignore
export class EntityAttributeComponent extends EntityComponent {
   ...
   public readonly effectiveMax: number;
   public readonly effectiveMin: number;
   public resetToDefaultValue(): void;
   public resetToMaxValue(): void;
   public resetToMinValue(): void;
   public setCurrentValue(value: number): boolean;
   private constructor();
}
//@ts-ignore
...
export class EntityBreathableComponent extends EntityComponent {
   ...
   public getBreatheBlocks(): Array<BlockPermutation>;
   public getNonBreatheBlocks(): Array<BlockPermutation>;
   private constructor();
}
//@ts-ignore
...
export class EntityColor2Component extends EntityComponent {
   public static readonly componentId = "minecraft:color2";
   public readonly value: PaletteColor;
   private constructor();
}
//@ts-ignore
...
export class EntityDieAfterEvent {
   ...
   public readonly deadEntity: Entity;
   private constructor();
}
...
export class EntityEquippableComponent extends EntityComponent {
   public static readonly componentId = "minecraft:equippable";
   public readonly totalArmor: number;
   public readonly totalToughness: number;
   public getEquipment(equipmentSlot: EquipmentSlot): (ItemStack | undefined);
   public getEquipmentSlot(equipmentSlot: EquipmentSlot): ContainerSlot;
   public setEquipment(equipmentSlot: EquipmentSlot, itemStack?: ItemStack): boolean;
   private constructor();
}
//@ts-ignore
export class EntityExhaustionComponent extends EntityAttributeComponent {
   public static readonly componentId = "minecraft:player.exhaustion";
   private constructor();
}
//@ts-ignore
...
export class EntityHealableComponent extends EntityComponent {
   public static readonly componentId = "minecraft:healable";
   public readonly forceUse: boolean;
...
export class EntityHealthChangedAfterEventSignal {
   public subscribe(callback: (arg0: EntityHealthChangedAfterEvent)=>void, options?: EntityEventOptions): (arg0: EntityHealthChangedAfterEvent)=>void;
   public unsubscribe(callback: (arg0: EntityHealthChangedAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
export class EntityHealthComponent extends EntityAttributeComponent {
   public static readonly componentId = "minecraft:health";
   private constructor();
}
export class EntityHitBlockAfterEvent {
   public readonly blockFace: Direction;
   public readonly damagingEntity: Entity;
   public readonly hitBlock: Block;
   public readonly hitBlockPermutation: BlockPermutation;
   private constructor();
}
export class EntityHitBlockAfterEventSignal {
   public subscribe(callback: (arg0: EntityHitBlockAfterEvent)=>void, options?: EntityEventOptions): (arg0: EntityHitBlockAfterEvent)=>void;
   public unsubscribe(callback: (arg0: EntityHitBlockAfterEvent)=>void): void;
   private constructor();
}
...
export class EntityHitEntityAfterEventSignal {
   public subscribe(callback: (arg0: EntityHitEntityAfterEvent)=>void, options?: EntityEventOptions): (arg0: EntityHitEntityAfterEvent)=>void;
   public unsubscribe(callback: (arg0: EntityHitEntityAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
export class EntityHungerComponent extends EntityAttributeComponent {
   public static readonly componentId = "minecraft:player.hunger";
   private constructor();
}
...
export class EntityLavaMovementComponent extends EntityAttributeComponent {
   public static readonly componentId = "minecraft:lava_movement";
   private constructor();
}
//@ts-ignore
export class EntityLeashableComponent extends EntityComponent {
   public static readonly componentId = "minecraft:leashable";
   public readonly canBeStolen: boolean;
   public readonly hardDistance: number;
   public readonly isLeashed: boolean;
   public readonly leashHolder?: Entity;
   public readonly leashHolderEntityId?: string;
   public readonly maxDistance: number;
   public readonly softDistance: number;
   public leashTo(leashHolder: Entity): void;
   public unleash(): void;
   private constructor();
}
...
export class EntityLoadAfterEventSignal {
   public subscribe(callback: (arg0: EntityLoadAfterEvent)=>void): (arg0: EntityLoadAfterEvent)=>void;
   public unsubscribe(callback: (arg0: EntityLoadAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
...
export class EntityMovementComponent extends EntityAttributeComponent {
   public static readonly componentId = "minecraft:movement";
   private constructor();
}
//@ts-ignore
...
export class EntityMovementGlideComponent extends EntityBaseMovementComponent {
   public static readonly componentId = "minecraft:movement.glide";
   public readonly speedWhenTurning: number;
...
export class EntityMovementSwayComponent extends EntityBaseMovementComponent {
   public static readonly componentId = "minecraft:movement.sway";
   public readonly swayAmplitude: number;
   public readonly swayFrequency: number;
   private constructor();
}
//@ts-ignore
export class EntityNavigationClimbComponent extends EntityNavigationComponent {
   public static readonly componentId = "minecraft:navigation.climb";
   private constructor();
}
//@ts-ignore
export class EntityNavigationComponent extends EntityComponent {
   public readonly avoidDamageBlocks: boolean;
   public readonly avoidPortals: boolean;
   public readonly avoidSun: boolean;
   public readonly avoidWater: boolean;
   public readonly canBreach: boolean;
   public readonly canBreakDoors: boolean;
   public readonly canFloat: boolean;
   public readonly canJump: boolean;
   public readonly canOpenDoors: boolean;
   public readonly canOpenIronDoors: boolean;
   public readonly canPassDoors: boolean;
   public readonly canPathFromAir: boolean;
   public readonly canPathOverLava: boolean;
   public readonly canPathOverWater: boolean;
   public readonly canSink: boolean;
   public readonly canSwim: boolean;
   public readonly canWalk: boolean;
   public readonly canWalkInLava: boolean;
   public readonly isAmphibious: boolean;
   private constructor();
}
//@ts-ignore
export class EntityNavigationFloatComponent extends EntityNavigationComponent {
   public static readonly componentId = "minecraft:navigation.float";
   private constructor();
}
//@ts-ignore
export class EntityNavigationFlyComponent extends EntityNavigationComponent {
   public static readonly componentId = "minecraft:navigation.fly";
   private constructor();
}
//@ts-ignore
export class EntityNavigationGenericComponent extends EntityNavigationComponent {
   public static readonly componentId = "minecraft:navigation.generic";
   private constructor();
}
//@ts-ignore
export class EntityNavigationHoverComponent extends EntityNavigationComponent {
   public static readonly componentId = "minecraft:navigation.hover";
   private constructor();
}
//@ts-ignore
export class EntityNavigationWalkComponent extends EntityNavigationComponent {
   public static readonly componentId = "minecraft:navigation.walk";
   private constructor();
}
//@ts-ignore
...
export class EntityProjectileComponent extends EntityComponent {
   public static readonly componentId = "minecraft:projectile";
   public airInertia: number;
   public catchFireOnHurt: boolean;
   public critParticlesOnProjectileHurt: boolean;
   public destroyOnProjectileHurt: boolean;
   public gravity: number;
   public hitEntitySound?: string;
   public hitGroundSound?: string;
   public hitParticle?: string;
   public lightningStrikeOnHit: boolean;
   public liquidInertia: number;
   public onFireTime: number;
   public owner?: Entity;
   public shouldBounceOnHit: boolean;
   public stopOnHit: boolean;
   public shoot(velocity: Vector3, options?: ProjectileShootOptions): void;
   private constructor();
}
//@ts-ignore
...
export class EntityRemoveAfterEvent {
   public readonly removedEntityId: string;
   public readonly typeId: string;
   private constructor();
}
export class EntityRemoveAfterEventSignal {
   public subscribe(callback: (arg0: EntityRemoveAfterEvent)=>void, options?: EntityEventOptions): (arg0: EntityRemoveAfterEvent)=>void;
   public unsubscribe(callback: (arg0: EntityRemoveAfterEvent)=>void): void;
   private constructor();
}
export class EntityRemoveBeforeEvent {
   public readonly removedEntity: Entity;
   private constructor();
}
export class EntityRemoveBeforeEventSignal {
   public subscribe(callback: (arg0: EntityRemoveBeforeEvent)=>void): (arg0: EntityRemoveBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: EntityRemoveBeforeEvent)=>void): void;
   private constructor();
}
//@ts-ignore
export class EntityRideableComponent extends EntityComponent {
   public static readonly componentId = "minecraft:rideable";
   public readonly controllingSeat: number;
   public readonly crouchingSkipInteract: boolean;
   public readonly interactText: string;
   public readonly passengerMaxWidth: number;
   public readonly pullInEntities: boolean;
   public readonly riderCanInteract: boolean;
   ...
   public getFamilyTypes(): Array<string>;
   public getRiders(): Array<Entity>;
   public getSeats(): Array<Seat>;
   private constructor();
}
//@ts-ignore
export class EntityRidingComponent extends EntityComponent {
   public static readonly componentId = "minecraft:riding";
   public readonly entityRidingOn: Entity;
   private constructor();
}
//@ts-ignore
export class EntitySaturationComponent extends EntityAttributeComponent {
   public static readonly componentId = "minecraft:player.saturation";
   private constructor();
}
//@ts-ignore
...
export class EntitySpawnAfterEvent {
   public readonly cause: EntityInitializationCause;
   public entity: Entity;
   private constructor();
}
...
export class EntityTameableComponent extends EntityComponent {
   public static readonly componentId = "minecraft:tameable";
   public readonly getTameItems: Array<ItemStack>;
   public readonly isTamed: boolean;
...
export class EntityTameMountComponent extends EntityComponent {
   ...
   public readonly isTamed: boolean;
   public readonly isTamedToPlayer: boolean;
   public readonly tamedToPlayer?: Player;
   public readonly tamedToPlayerId?: string;
   public tame(showParticles: boolean): void;
   public tameToPlayer(showParticles: boolean, player: Player): boolean;
   private constructor();
}
...
export class EntityTypeFamilyComponent extends EntityComponent {
   public static readonly componentId = "minecraft:type_family";
   public getTypeFamilies(): Array<string>;
   public hasTypeFamily(typeFamily: string): boolean;
   private constructor();
}
export class EntityTypes {
   public static get(identifier: string): (EntityType | undefined);
...
export class ExplosionAfterEvent {
   public readonly dimension: Dimension;
   public readonly source?: Entity;
   public getImpactedBlocks(): Array<Block>;
   private constructor();
}
export class ExplosionAfterEventSignal {
   public subscribe(callback: (arg0: ExplosionAfterEvent)=>void): (arg0: ExplosionAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ExplosionAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
export class ExplosionBeforeEvent extends ExplosionAfterEvent {
   public cancel: boolean;
   public setImpactedBlocks(blocks: Array<Block>): void;
   private constructor();
}
export class ExplosionBeforeEventSignal {
   public subscribe(callback: (arg0: ExplosionBeforeEvent)=>void): (arg0: ExplosionBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: ExplosionBeforeEvent)=>void): void;
   private constructor();
}
//@ts-ignore
...
export class FillContainerFunction extends LootItemFunction {
   public readonly lootTable: string;
   private constructor();
}
...
export class GameRuleChangeAfterEventSignal {
   public subscribe(callback: (arg0: GameRuleChangeAfterEvent)=>void): (arg0: GameRuleChangeAfterEvent)=>void;
   public unsubscribe(callback: (arg0: GameRuleChangeAfterEvent)=>void): void;
   private constructor();
}
export class GameRules {
   ...
   public showDaysPlayed: boolean;
   public showDeathMessages: boolean;
   public showRecipeMessages: boolean;
   public showTags: boolean;
   public spawnRadius: number;
   public tntExplodes: boolean;
   public tntExplosionDropDecay: boolean;
   private constructor();
}
export class InputInfo {
   public readonly lastInputModeUsed: InputMode;
   public readonly touchOnlyAffectsHotbar: boolean;
   public getButtonState(button: InputButton): ButtonState;
...
export class ItemBookComponent extends ItemComponent {
   ...
   public readonly contents: Array<string | undefined>;
   public readonly isSigned: boolean;
   public readonly pageCount: number;
   public readonly rawContents: Array<RawMessage | undefined>;
   public readonly title?: string;
   public getPageContent(pageIndex: number): (string | undefined);
   public getRawPageContent(pageIndex: number): (RawMessage | undefined);
   public insertPage(pageIndex: number, content: Array<RawMessage | string> | RawMessage | string): void;
   public removePage(pageIndex: number): void;
   public setContents(contents: Array<Array<RawMessage | string> | RawMessage | string>): void;
   public setPageContent(pageIndex: number, content: Array<RawMessage | string> | RawMessage | string): void;
   public signBook(title: string, author: string): void;
   private constructor();
}
...
export class ItemCompleteUseAfterEventSignal {
   public subscribe(callback: (arg0: ItemCompleteUseAfterEvent)=>void): (arg0: ItemCompleteUseAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ItemCompleteUseAfterEvent)=>void): void;
   private constructor();
}
...
export class ItemComponentBeforeDurabilityDamageEvent {
   ...
   public durabilityDamage: number;
   public readonly hitEntity: Entity;
...
export class ItemComponentHitEntityEvent {
   public readonly attackingEntity: Entity;
   public readonly hadEffect: boolean;
   public readonly hitEntity: Entity;
   public readonly itemStack?: ItemStack;
   private constructor();
}
export class ItemComponentMineBlockEvent {
   public readonly block: Block;
   public readonly itemStack?: ItemStack;
   public readonly minedBlockPermutation: BlockPermutation;
   public readonly source: Entity;
   private constructor();
}
export class ItemComponentRegistry {
   public registerCustomComponent(name: string, itemCustomComponent: ItemCustomComponent): void;
   private constructor();
}
...
export class ItemComponentUseOnEvent extends ItemUseOnEvent {
   public readonly source: Entity;
   public readonly usedOnBlockPermutation: BlockPermutation;
   private constructor();
}
//@ts-ignore
export class ItemCompostableComponent extends ItemComponent {
   public static readonly componentId = "minecraft:compostable";
   public readonly compostingChance: number;
   private constructor();
}
//@ts-ignore
export class ItemCooldownComponent extends ItemComponent {
   public static readonly componentId = "minecraft:cooldown";
   public readonly cooldownCategory: string;
   public readonly cooldownTicks: number;
   public getCooldownTicksRemaining(player: Player): number;
   public isCooldownCategory(cooldownCategory: string): boolean;
   public startCooldown(player: Player): void;
   private constructor();
}
//@ts-ignore
...
export class ItemDyeableComponent extends ItemComponent {
   public static readonly componentId = "minecraft:dyeable";
   public color?: RGB;
   public readonly defaultColor?: RGB;
   private constructor();
}
//@ts-ignore
export class ItemEnchantableComponent extends ItemComponent {
   public static readonly componentId = "minecraft:enchantable";
   public readonly slots: Array<EnchantmentSlot>;
   public addEnchantment(enchantment: Enchantment): void;
   public addEnchantments(enchantments: Array<Enchantment>): void;
   public canAddEnchantment(enchantment: Enchantment): boolean;
   public getEnchantment(enchantmentType: EnchantmentType | string): (Enchantment | undefined);
   public getEnchantments(): Array<Enchantment>;
   public hasEnchantment(enchantmentType: EnchantmentType | string): boolean;
   public removeAllEnchantments(): void;
   public removeEnchantment(enchantmentType: EnchantmentType | string): void;
   private constructor();
}
//@ts-ignore
export class ItemFoodComponent extends ItemComponent {
   public static readonly componentId = "minecraft:food";
   public readonly canAlwaysEat: boolean;
   public readonly nutrition: number;
   public readonly saturationModifier: number;
   public readonly usingConvertsTo: string;
   private constructor();
}
//@ts-ignore
...
export class ItemReleaseUseAfterEventSignal {
   public subscribe(callback: (arg0: ItemReleaseUseAfterEvent)=>void): (arg0: ItemReleaseUseAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ItemReleaseUseAfterEvent)=>void): void;
   private constructor();
}
export class ItemStack {
   ...
   public hasTag(tag: string): boolean;
   public isStackableWith(itemStack: ItemStack): boolean;
   public matches(itemName: string, states?: Record<string,boolean | number | string>): boolean;
   public setCanDestroy(blockIdentifiers?: Array<string>): void;
   public setCanPlaceOn(blockIdentifiers?: Array<string>): void;
   public setDynamicProperties(values: Record<string,boolean | number | number | string | Vector3 | undefined>): void;
   public setDynamicProperty(identifier: string, value?: boolean | number | number | string | Vector3): void;
...
export class ItemStartUseAfterEventSignal {
   public subscribe(callback: (arg0: ItemStartUseAfterEvent)=>void): (arg0: ItemStartUseAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ItemStartUseAfterEvent)=>void): void;
   private constructor();
}
...
export class ItemStartUseOnAfterEventSignal {
   public subscribe(callback: (arg0: ItemStartUseOnAfterEvent)=>void): (arg0: ItemStartUseOnAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ItemStartUseOnAfterEvent)=>void): void;
   private constructor();
}
...
export class ItemStopUseAfterEventSignal {
   public subscribe(callback: (arg0: ItemStopUseAfterEvent)=>void): (arg0: ItemStopUseAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ItemStopUseAfterEvent)=>void): void;
   private constructor();
}
...
export class ItemStopUseOnAfterEventSignal {
   public subscribe(callback: (arg0: ItemStopUseOnAfterEvent)=>void): (arg0: ItemStopUseOnAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ItemStopUseOnAfterEvent)=>void): void;
   private constructor();
}
...
export class ItemTypes {
   public static get(itemId: string): (ItemType | undefined);
...
export class ItemUseAfterEventSignal {
   public subscribe(callback: (arg0: ItemUseAfterEvent)=>void): (arg0: ItemUseAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ItemUseAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
...
export class ItemUseBeforeEventSignal {
   public subscribe(callback: (arg0: ItemUseBeforeEvent)=>void): (arg0: ItemUseBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: ItemUseBeforeEvent)=>void): void;
   private constructor();
}
...
export class LeverActionAfterEventSignal {
   public subscribe(callback: (arg0: LeverActionAfterEvent)=>void): (arg0: LeverActionAfterEvent)=>void;
...
export class ListBlockVolume extends BlockVolumeBase {
   ...
   public constructor(locations: Array<Vector3>);
...
export class LootPool {
   public readonly bonusRolls: common.NumberRange;
   public readonly conditions: Array<LootItemCondition>;
   public readonly entries: Array<LootPoolEntry>;
   public readonly rolls: common.NumberRange;
   public readonly tiers?: LootPoolTiers;
   private constructor();
}
export class LootPoolEntry {
   public readonly quality: number;
   public readonly subTable?: LootPoolEntry;
   public readonly weight: number;
   private constructor();
}
export class LootPoolTiers {
   public readonly bonusChance: number;
   public readonly bonusRolls: number;
   public readonly initialRange: number;
   private constructor();
}
export class LootTable {
   public readonly path: string;
   public readonly pools: Array<LootPool>;
   private constructor();
}
//@ts-ignore
...
export class LootTableManager {
   public generateLootFromBlock(block: Block, tool?: ItemStack): (Array<ItemStack> | undefined);
   public generateLootFromBlockPermutation(blockPermutation: BlockPermutation, tool?: ItemStack): (Array<ItemStack> | undefined);
   public generateLootFromBlockType(scriptBlockType: BlockType, tool?: ItemStack): (Array<ItemStack> | undefined);
   public generateLootFromEntity(entity: Entity, tool?: ItemStack): (Array<ItemStack> | undefined);
   public generateLootFromEntityType(entityType: EntityType, tool?: ItemStack): (Array<ItemStack> | undefined);
   public generateLootFromTable(lootTable: LootTable, tool?: ItemStack): (Array<ItemStack> | undefined);
   public getLootTable(path: string): (LootTable | undefined);
   private constructor();
}
//@ts-ignore
...
export class MatchToolCondition extends LootItemCondition {
   public readonly count: common.NumberRange;
   public readonly durability: common.NumberRange;
   public readonly enchantments: Array<EnchantInfo>;
   public readonly itemName: string;
   public readonly itemTagsAll: Array<string>;
   public readonly itemTagsAny: Array<string>;
...
export class MolangVariableMap {
   ...
   public setColorRGBA(variableName: string, color: RGBA): void;
...
export class PistonActivateAfterEvent extends BlockEvent {
   public readonly isExpanding: boolean;
   public readonly piston: BlockPistonComponent;
   private constructor();
}
export class PistonActivateAfterEventSignal {
   public subscribe(callback: (arg0: PistonActivateAfterEvent)=>void): (arg0: PistonActivateAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PistonActivateAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
export class Player extends Entity {
   ...
   public readonly isEmoting: boolean;
   ...
   public setPropertyOverrideForEntity(targetEntity: Entity, identifier: string, value: boolean | number | string): void;
...
export class PlayerBreakBlockAfterEvent extends BlockEvent {
   public readonly brokenBlockPermutation: BlockPermutation;
   public readonly itemStackAfterBreak?: ItemStack;
   public readonly itemStackBeforeBreak?: ItemStack;
   public readonly player: Player;
   private constructor();
}
export class PlayerBreakBlockAfterEventSignal {
   public subscribe(callback: (arg0: PlayerBreakBlockAfterEvent)=>void, options?: BlockEventOptions): (arg0: PlayerBreakBlockAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerBreakBlockAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
...
export class PlayerBreakBlockBeforeEventSignal {
   public subscribe(callback: (arg0: PlayerBreakBlockBeforeEvent)=>void, options?: BlockEventOptions): (arg0: PlayerBreakBlockBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerBreakBlockBeforeEvent)=>void): void;
   private constructor();
}
export class PlayerButtonInputAfterEvent {
   public readonly button: InputButton;
   public readonly newButtonState: ButtonState;
   public readonly player: Player;
   private constructor();
}
...
export class PlayerDimensionChangeAfterEvent {
   ...
   public readonly toLocation: Vector3;
   private constructor();
}
export class PlayerDimensionChangeAfterEventSignal {
   public subscribe(callback: (arg0: PlayerDimensionChangeAfterEvent)=>void): (arg0: PlayerDimensionChangeAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerDimensionChangeAfterEvent)=>void): void;
   private constructor();
}
export class PlayerEmoteAfterEvent {
   public readonly personaPieceId: string;
   public readonly player: Player;
   private constructor();
}
export class PlayerEmoteAfterEventSignal {
   public subscribe(callback: (arg0: PlayerEmoteAfterEvent)=>void): (arg0: PlayerEmoteAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerEmoteAfterEvent)=>void): void;
   private constructor();
}
...
export class PlayerGameModeChangeAfterEventSignal {
   public subscribe(callback: (arg0: PlayerGameModeChangeAfterEvent)=>void): (arg0: PlayerGameModeChangeAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerGameModeChangeAfterEvent)=>void): void;
   private constructor();
}
export class PlayerGameModeChangeBeforeEvent {
   ...
   public readonly fromGameMode: GameMode;
   public readonly player: Player;
   public toGameMode: GameMode;
   private constructor();
}
export class PlayerGameModeChangeBeforeEventSignal {
   public subscribe(callback: (arg0: PlayerGameModeChangeBeforeEvent)=>void): (arg0: PlayerGameModeChangeBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerGameModeChangeBeforeEvent)=>void): void;
   private constructor();
}
export class PlayerHotbarSelectedSlotChangeAfterEvent {
   public readonly itemStack?: ItemStack;
   public readonly newSlotSelected: number;
   public readonly player: Player;
   public readonly previousSlotSelected: number;
   private constructor();
}
export class PlayerHotbarSelectedSlotChangeAfterEventSignal {
   public subscribe(callback: (arg0: PlayerHotbarSelectedSlotChangeAfterEvent)=>void, options?: HotbarEventOptions): (arg0: PlayerHotbarSelectedSlotChangeAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerHotbarSelectedSlotChangeAfterEvent)=>void): void;
   private constructor();
}
export class PlayerInputModeChangeAfterEvent {
   public readonly newInputModeUsed: InputMode;
   public readonly player: Player;
   public readonly previousInputModeUsed: InputMode;
   private constructor();
}
export class PlayerInputModeChangeAfterEventSignal {
   public subscribe(callback: (arg0: PlayerInputModeChangeAfterEvent)=>void): (arg0: PlayerInputModeChangeAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerInputModeChangeAfterEvent)=>void): void;
   private constructor();
}
export class PlayerInputPermissionCategoryChangeAfterEvent {
   public readonly category: InputPermissionCategory;
   public readonly enabled: boolean;
   public readonly player: Player;
   private constructor();
}
export class PlayerInputPermissionCategoryChangeAfterEventSignal {
   public subscribe(callback: (arg0: PlayerInputPermissionCategoryChangeAfterEvent)=>void): (arg0: PlayerInputPermissionCategoryChangeAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerInputPermissionCategoryChangeAfterEvent)=>void): void;
   private constructor();
}
export class PlayerInputPermissions {
   public isPermissionCategoryEnabled(permissionCategory: InputPermissionCategory): boolean;
   public setPermissionCategory(permissionCategory: InputPermissionCategory, isEnabled: boolean): void;
   private constructor();
}
export class PlayerInteractWithBlockAfterEvent {
   public readonly beforeItemStack?: ItemStack;
   public readonly block: Block;
   public readonly blockFace: Direction;
   public readonly faceLocation: Vector3;
   public readonly isFirstEvent: boolean;
   public readonly itemStack?: ItemStack;
   public readonly player: Player;
   private constructor();
}
export class PlayerInteractWithBlockAfterEventSignal {
   public subscribe(callback: (arg0: PlayerInteractWithBlockAfterEvent)=>void): (arg0: PlayerInteractWithBlockAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerInteractWithBlockAfterEvent)=>void): void;
   private constructor();
}
...
export class PlayerInteractWithBlockBeforeEventSignal {
   public subscribe(callback: (arg0: PlayerInteractWithBlockBeforeEvent)=>void): (arg0: PlayerInteractWithBlockBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerInteractWithBlockBeforeEvent)=>void): void;
   private constructor();
}
...
export class PlayerInteractWithEntityAfterEventSignal {
   public subscribe(callback: (arg0: PlayerInteractWithEntityAfterEvent)=>void): (arg0: PlayerInteractWithEntityAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerInteractWithEntityAfterEvent)=>void): void;
   private constructor();
}
...
export class PlayerInteractWithEntityBeforeEventSignal {
   public subscribe(callback: (arg0: PlayerInteractWithEntityBeforeEvent)=>void): (arg0: PlayerInteractWithEntityBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerInteractWithEntityBeforeEvent)=>void): void;
   private constructor();
}
export class PlayerInventoryItemChangeAfterEvent {
   public readonly beforeItemStack?: ItemStack;
   public readonly inventoryType: PlayerInventoryType;
   public readonly itemStack?: ItemStack;
   public readonly player: Player;
...
export class PlayerJoinAfterEventSignal {
   public subscribe(callback: (arg0: PlayerJoinAfterEvent)=>void): (arg0: PlayerJoinAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerJoinAfterEvent)=>void): void;
   private constructor();
}
...
export class PlayerLeaveAfterEventSignal {
   public subscribe(callback: (arg0: PlayerLeaveAfterEvent)=>void): (arg0: PlayerLeaveAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerLeaveAfterEvent)=>void): void;
   private constructor();
}
...
export class PlayerLeaveBeforeEventSignal {
   public subscribe(callback: (arg0: PlayerLeaveBeforeEvent)=>void): (arg0: PlayerLeaveBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: PlayerLeaveBeforeEvent)=>void): void;
   private constructor();
}
//@ts-ignore
...
export class PlayerPlaceBlockAfterEventSignal {
   public subscribe(callback: (arg0: PlayerPlaceBlockAfterEvent)=>void, options?: BlockEventOptions): (arg0: PlayerPlaceBlockAfterEvent)=>void;
...
export class PlayerSwingStartAfterEventSignal {
   public subscribe(callback: (arg0: PlayerSwingStartAfterEvent)=>void, options?: PlayerSwingEventOptions): (arg0: PlayerSwingStartAfterEvent)=>void;
...
export class PressurePlatePopAfterEvent extends BlockEvent {
   public readonly previousRedstonePower: number;
   public readonly redstonePower: number;
   private constructor();
}
export class PressurePlatePopAfterEventSignal {
   public subscribe(callback: (arg0: PressurePlatePopAfterEvent)=>void): (arg0: PressurePlatePopAfterEvent)=>void;
   public unsubscribe(callback: (arg0: PressurePlatePopAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
...
export class PressurePlatePushAfterEventSignal {
   public subscribe(callback: (arg0: PressurePlatePushAfterEvent)=>void): (arg0: PressurePlatePushAfterEvent)=>void;
...
export class ProjectileHitBlockAfterEvent {
   ...
   public readonly location: Vector3;
   public readonly projectile: Entity;
   public readonly source?: Entity;
   public getBlockHit(): BlockHitInformation;
   private constructor();
}
export class ProjectileHitBlockAfterEventSignal {
   public subscribe(callback: (arg0: ProjectileHitBlockAfterEvent)=>void): (arg0: ProjectileHitBlockAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ProjectileHitBlockAfterEvent)=>void): void;
   private constructor();
}
export class ProjectileHitEntityAfterEvent {
   ...
   public readonly projectile: Entity;
   public readonly source?: Entity;
   public getEntityHit(): EntityHitInformation;
   private constructor();
}
export class ProjectileHitEntityAfterEventSignal {
   public subscribe(callback: (arg0: ProjectileHitEntityAfterEvent)=>void): (arg0: ProjectileHitEntityAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ProjectileHitEntityAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
export class RandomAuxValueFunction extends LootItemFunction {
   public readonly values: common.NumberRange;
   private constructor();
}
//@ts-ignore
export class RandomBlockStateFunction extends LootItemFunction {
   public readonly blockState: string;
   public readonly values: common.NumberRange;
   private constructor();
}
//@ts-ignore
...
export class RandomChanceWithLootingCondition extends LootItemCondition {
   public readonly chance: number;
   public readonly lootingMultiplier: number;
   private constructor();
}
//@ts-ignore
export class RandomDifficultyChanceCondition extends LootItemCondition {
   public readonly chances: Array<number>;
   private constructor();
}
//@ts-ignore
...
export class Scoreboard {
   public addObjective(objectiveId: string, displayName?: string): ScoreboardObjective;
   public clearObjectiveAtDisplaySlot(displaySlotId: DisplaySlotId): (ScoreboardObjective | undefined);
   public getObjective(objectiveId: string): (ScoreboardObjective | undefined);
   public getObjectiveAtDisplaySlot(displaySlotId: DisplaySlotId): (ScoreboardObjectiveDisplayOptions | undefined);
   public getObjectives(): Array<ScoreboardObjective>;
   public getParticipants(): Array<ScoreboardIdentity>;
   public removeObjective(objectiveId: ScoreboardObjective | string): boolean;
   public setObjectiveAtDisplaySlot(displaySlotId: DisplaySlotId, objectiveDisplaySetting: ScoreboardObjectiveDisplayOptions): (ScoreboardObjective | undefined);
   private constructor();
}
...
export class ScoreboardObjective {
   ...
   public readonly id: string;
   public readonly isValid: boolean;
   public addScore(participant: Entity | ScoreboardIdentity | string, scoreToAdd: number): number;
   public getParticipants(): Array<ScoreboardIdentity>;
   public getScore(participant: Entity | ScoreboardIdentity | string): (number | undefined);
   public getScores(): Array<ScoreboardScoreInfo>;
   public hasParticipant(participant: Entity | ScoreboardIdentity | string): boolean;
   public removeParticipant(participant: Entity | ScoreboardIdentity | string): boolean;
   public setScore(participant: Entity | ScoreboardIdentity | string, score: number): void;
   private constructor();
}
export class ScoreboardScoreInfo {
   public readonly participant: ScoreboardIdentity;
   public readonly score: number;
   private constructor();
}
export class ScreenDisplay {
   public readonly isValid: boolean;
   public getHiddenHudElements(): Array<HudElement>;
   public hideAllExcept(hudElements?: Array<HudElement>): void;
   public isForcedHidden(hudElement: HudElement): boolean;
   public resetHudElementsVisibility(): void;
   public setActionBar(text: Array<RawMessage | string> | RawMessage | string): void;
   public setHudVisibility(visible: HudVisibility, hudElements?: Array<HudElement>): void;
   public setTitle(title: Array<RawMessage | string> | RawMessage | string, options?: TitleDisplayOptions): void;
   public updateSubtitle(subtitle: Array<RawMessage | string> | RawMessage | string): void;
   private constructor();
}
export class ScriptEventCommandMessageAfterEvent {
   ...
   public readonly sourceBlock?: Block;
   public readonly sourceEntity?: Entity;
   public readonly sourceType: ScriptEventSource;
   private constructor();
}
...
export class Seat {
   public readonly lockRiderRotation: number;
   public readonly maxRiderCount: number;
...
export class SetOminousBottleFunction extends LootItemFunction {
   public readonly amplifier: common.NumberRange;
   private constructor();
}
//@ts-ignore
...
export class SetStewEffectFunction extends LootItemFunction {
   public readonly effects: Array<number>;
   private constructor();
}
export class ShutdownBeforeEventSignal {
   public subscribe(callback: (arg0: ShutdownEvent)=>void): (arg0: ShutdownEvent)=>void;
   public unsubscribe(callback: (arg0: ShutdownEvent)=>void): void;
   private constructor();
}
...
export class StartupBeforeEventSignal {
   public subscribe(callback: (arg0: StartupEvent)=>void): (arg0: StartupEvent)=>void;
   public unsubscribe(callback: (arg0: StartupEvent)=>void): void;
   private constructor();
}
...
export class Structure {
   ...
   public getIsWaterlogged(location: Vector3): boolean;
   public saveAs(identifier: string, saveMode?: StructureSaveMode): Structure;
   public saveToWorld(): void;
   public setBlockPermutation(location: Vector3, blockPermutation?: BlockPermutation, waterlogged?: boolean): void;
   private constructor();
}
export class StructureManager {
   public createEmpty(identifier: string, size: Vector3, saveMode?: StructureSaveMode): Structure;
   ...
   public placeJigsawStructure(identifier: string, dimension: Dimension, location: Vector3, options?: JigsawStructurePlaceOptions): BlockBoundingBox;
   private constructor();
}
export class System {
   ...
   public readonly isEditorWorld: boolean;
   public readonly serverSystemInfo: SystemInfo;
   public clearJob(jobId: number): void;
   ...
   public runJob(generator: Generator<undefined>): number;
   public runTimeout(callback: ()=>void, tickDelay?: number): number;
   public sendScriptEvent(id: string, message: string): void;
   public waitTicks(ticks: number): Promise<void>;
   private constructor();
}
export class SystemAfterEvents {
   public readonly scriptEventReceive: ScriptEventCommandMessageAfterEventSignal;
   private constructor();
}
...
export class TripWireTripAfterEvent extends BlockEvent {
   public readonly isPowered: boolean;
   public readonly sources: Array<Entity>;
   private constructor();
}
...
export class WeatherChangeAfterEvent {
   ...
   public readonly newWeather: WeatherType;
   public readonly previousWeather: WeatherType;
   private constructor();
}
export class WeatherChangeAfterEventSignal {
   public subscribe(callback: (arg0: WeatherChangeAfterEvent)=>void): (arg0: WeatherChangeAfterEvent)=>void;
   public unsubscribe(callback: (arg0: WeatherChangeAfterEvent)=>void): void;
   private constructor();
}
export class WeatherChangeBeforeEvent {
   public cancel: boolean;
   public duration: number;
   public newWeather: WeatherType;
   public readonly previousWeather: WeatherType;
   private constructor();
}
export class WeatherChangeBeforeEventSignal {
   public subscribe(callback: (arg0: WeatherChangeBeforeEvent)=>void): (arg0: WeatherChangeBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: WeatherChangeBeforeEvent)=>void): void;
   private constructor();
}
export class World {
...
export class WorldAfterEvents {
   ...
   public readonly itemReleaseUse: ItemReleaseUseAfterEventSignal;
   public readonly itemStartUse: ItemStartUseAfterEventSignal;
   public readonly itemStartUseOn: ItemStartUseOnAfterEventSignal;
   public readonly itemStopUse: ItemStopUseAfterEventSignal;
   ...
   public readonly playerHotbarSelectedSlotChange: PlayerHotbarSelectedSlotChangeAfterEventSignal;
   public readonly playerInputModeChange: PlayerInputModeChangeAfterEventSignal;
   public readonly playerInputPermissionCategoryChange: PlayerInputPermissionCategoryChangeAfterEventSignal;
   public readonly playerInteractWithBlock: PlayerInteractWithBlockAfterEventSignal;
   public readonly playerInteractWithEntity: PlayerInteractWithEntityAfterEventSignal;
   public readonly playerInventoryItemChange: PlayerInventoryItemChangeAfterEventSignal;
   public readonly playerJoin: PlayerJoinAfterEventSignal;
...
export class WorldLoadAfterEventSignal {
   public subscribe(callback: (arg0: WorldLoadAfterEvent)=>void): (arg0: WorldLoadAfterEvent)=>void;
   public unsubscribe(callback: (arg0: WorldLoadAfterEvent)=>void): void;
   private constructor();
}
...
export class BookError extends Error {
   public readonly reason: BookErrorReason;
   private constructor();
}
//@ts-ignore
...
export class ContainerRulesError extends Error {
   public readonly reason: ContainerRulesErrorReason;
   private constructor();
}
//@ts-ignore
export class CustomCommandError extends Error {
   public readonly reason: CustomCommandErrorReason;
   private constructor();
}
//@ts-ignore
...
export class NamespaceNameError extends Error {
   public readonly reason: NamespaceNameErrorReason;
   private constructor();
}
//@ts-ignore
