...
export class BlockComponentPlayerDestroyEvent extends BlockEvent {
   public readonly destroyedBlockPermutation: BlockPermutation;
...
export class BlockFluidContainerComponent extends BlockComponent {
   public static readonly componentId = "minecraft:fluidContainer";
...
export class Camera {
   ...
   public setCamera(cameraPreset: string, setOptions?: CameraDefaultOptions | CameraFixedBoomOptions | CameraSetFacingOptions | CameraSetLocationOptions | CameraSetPosOptions | CameraSetRotOptions | CameraTargetOptions): void;
   private constructor();
}
//@ts-ignore
...
export class ItemUseOnAfterEventSignal {
   public subscribe(callback: (arg0: ItemUseOnAfterEvent)=>void): (arg0: ItemUseOnAfterEvent)=>void;
   public unsubscribe(callback: (arg0: ItemUseOnAfterEvent)=>void): void;
   private constructor();
}
//@ts-ignore
...
export class ItemUseOnBeforeEventSignal {
   public subscribe(callback: (arg0: ItemUseOnBeforeEvent)=>void): (arg0: ItemUseOnBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: ItemUseOnBeforeEvent)=>void): void;
   private constructor();
}
...
export class WorldAfterEvents {
   ...
   public readonly itemUseOn: ItemUseOnAfterEventSignal;
   ...
   public readonly worldInitialize: WorldInitializeAfterEventSignal;
   private constructor();
}
export class WorldBeforeEvents {
   ...
   public readonly itemUseOn: ItemUseOnBeforeEventSignal;
   ...
   public readonly worldInitialize: WorldInitializeBeforeEventSignal;
   private constructor();
}
...
export class WorldInitializeAfterEventSignal {
   public subscribe(callback: (arg0: WorldInitializeAfterEvent)=>void): (arg0: WorldInitializeAfterEvent)=>void;
   public unsubscribe(callback: (arg0: WorldInitializeAfterEvent)=>void): void;
   private constructor();
}
...
export class WorldInitializeBeforeEventSignal {
   public subscribe(callback: (arg0: WorldInitializeBeforeEvent)=>void): (arg0: WorldInitializeBeforeEvent)=>void;
   public unsubscribe(callback: (arg0: WorldInitializeBeforeEvent)=>void): void;
   private constructor();
}
