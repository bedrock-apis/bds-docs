...
export class WebServer implements AsyncIterableIterator<string> {
    ...
    public constructor(port: number, timeout: number){
        ...
        this.task = setTimeout(()=>{this.return(); this.task === null;},timeout)
    }
    public wasTerminatedByTimeout(){return this.task === null;}
    ...
    public [Symbol.asyncIterator](): this {return this;}
}