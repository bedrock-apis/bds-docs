...
// Classes - 163
export class Block { public readonly dimension: Dimension; public readonly isAir: boolean; public readonly isLiquid: boolean; public readonly location: Vector3; public readonly permutation: BlockPermutation; public readonly x: number; public readonly y: number; public readonly z: number; public above(steps?: number): (Block | undefined); public below(steps?: number): (Block | undefined); public bottomCenter(): Vector3; public center(): Vector3; public east(steps?: number): (Block | undefined); public getComponent(componentId: string): (BlockComponent | undefined); public isValid(): boolean; public north(steps?: number): (Block | undefined); public offset(offset: Vector3): (Block | undefined); public setPermutation(permutation: BlockPermutation): void; public south(steps?: number): (Block | undefined); public west(steps?: number): (Block | undefined); private constructor();};
...
//@ts-ignore extending for classes with private constructor is possible with native API
export class EntityEquippableComponent extends EntityComponent{ public static readonly componentId = "minecraft:equippable"; public getEquipment(equipmentSlot: EquipmentSlot): (ItemStack | undefined); public setEquipment(equipmentSlot: EquipmentSlot, itemStack?: ItemStack): boolean; private constructor();};
//@ts-ignore extending for classes with private constructor is possible with native API
...
export class ItemStack { public amount: number; public readonly isStackable: boolean; public keepOnDeath: boolean; public lockMode: ItemLockMode; public readonly maxAmount: number; public nameTag?: string; public readonly type: ItemType; public readonly typeId: string; public clone(): ItemStack; public constructor(itemType: ItemType | string, amount?: number); public getCanDestroy(): string[]; public getCanPlaceOn(): string[]; public getComponent(componentId: string): (ItemComponent | undefined); public getComponents(): ItemComponent[]; public getLore(): string[]; public getTags(): string[]; public hasComponent(componentId: string): boolean; public hasTag(tag: string): boolean; public isStackableWith(itemStack: ItemStack): boolean; public setCanDestroy(blockIdentifiers?: string[]): void; public setCanPlaceOn(blockIdentifiers?: string[]): void; public setLore(loreList?: (RawMessage | string)[]): void;};
