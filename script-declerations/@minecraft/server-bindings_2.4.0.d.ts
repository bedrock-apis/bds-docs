...
export enum ItemComponentTypes { Book = "minecraft:book", Compostable = "minecraft:compostable", Cooldown = "minecraft:cooldown", Durability = "minecraft:durability", Dyeable = "minecraft:dyeable", Enchantable = "minecraft:enchantable", Food = "minecraft:food", Inventory = "minecraft:inventory"};
...
export class BlockVolumeBase { public getBlockLocationIterator(): BlockLocationIterator; public getCapacity(): number; public getMax(): Vector3; public getMin(): Vector3; public getSpan(): Vector3; public isInside(location: Vector3): boolean; public translate(delta: Vector3): void; private constructor();};
//@ts-ignore extending for classes with private constructor is possible with native API
...
export class SystemBeforeEvents { public readonly shutdown: ShutdownBeforeEventSignal; public readonly startup: StartupBeforeEventSignal; private constructor();};
