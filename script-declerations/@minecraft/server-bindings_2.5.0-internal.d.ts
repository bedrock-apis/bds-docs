...
export enum EntitySwingSource { Attack = "Attack", Build = "Build", DropItem = "DropItem", Event = "Event", Interact = "Interact", Mine = "Mine", None = "None", ThrowItem = "ThrowItem", UseItem = "UseItem"};
...
export enum TickingAreaErrorReason { IdentifierAlreadyExists = "IdentifierAlreadyExists", OverChunkLimit = "OverChunkLimit", SideLengthExceeded = "SideLengthExceeded", UnknownIdentifier = "UnknownIdentifier"};
...
export interface PlayerSwingEventOptions { heldItemOption?: HeldItemOption; swingSource?: EntitySwingSource};
...
// Classes - 379
export class AimAssistCategory { public readonly defaultBlockPriority: number; public readonly defaultEntityPriority: number; public readonly identifier: string; public getBlockPriorities(): Record<string,number>; public getBlockTagPriorities(): Record<string,number>; public getEntityPriorities(): Record<string,number>; private constructor();};
export class AimAssistCategorySettings { public defaultBlockPriority: number; public defaultEntityPriority: number; public readonly identifier: string; public constructor(identifier: string); public getBlockPriorities(): Record<string,number>; public getBlockTagPriorities(): Record<string,number>; public getEntityPriorities(): Record<string,number>; public setBlockPriorities(blockPriorities: Record<string,number>): void; public setBlockTagPriorities(blockTagPriorities: Record<string,number>): void; public setEntityPriorities(entityPriorities: Record<string,number>): void;};
export class AimAssistPreset { public readonly defaultItemSettings?: string; public readonly handSettings?: string; public readonly identifier: string; public getExcludedBlockTagTargets(): string[]; public getExcludedBlockTargets(): string[]; public getExcludedEntityTargets(): string[]; public getItemSettings(): Record<string,string>; public getLiquidTargetingItems(): string[]; private constructor();};
export class AimAssistPresetSettings { public defaultItemSettings?: string; public handSettings?: string; public readonly identifier: string; public constructor(identifier: string); public getExcludedBlockTagTargets(): (string[] | undefined); public getExcludedBlockTargets(): (string[] | undefined); public getExcludedEntityTargets(): (string[] | undefined); public getItemSettings(): Record<string,string>; public getLiquidTargetingItems(): (string[] | undefined); public setExcludedBlockTagTargets(blockTagTargets?: string[]): void; public setExcludedBlockTargets(blockTargets?: string[]): void; public setExcludedEntityTargets(entityTargets?: string[]): void; public setItemSettings(itemSettings: Record<string,string>): void; public setLiquidTargetingItems(items?: string[]): void;};
...
export class EntityDefinitionFeedItem { public readonly growth: number; public readonly item: string; public readonly resultItem: string; private constructor();};
...
export class FeedItem { public readonly healAmount: number; public readonly item: string; public readonly resultItem: string; public getEffects(): FeedItemEffect[]; private constructor();};
...
export class PlayerSwingStartAfterEvent { public readonly heldItemStack?: ItemStack; public readonly player: Player; public readonly swingSource: EntitySwingSource; private constructor();};
...
export class TickingAreaManager { public readonly chunkCount: number; public readonly maxChunkCount: number; public createTickingArea(identifier: string, options: TickingAreaOptions): Promise<TickingArea>; public getAllTickingAreas(): TickingArea[]; public getTickingArea(identifier: string | TickingArea): (TickingArea | undefined); public hasCapacity(options: TickingAreaOptions): boolean; public hasTickingArea(identifier: string): boolean; public removeAllTickingAreas(): void; public removeTickingArea(identifier: string | TickingArea): void; private constructor();};
...
export class TickingAreaError extends Error{ public readonly reason: TickingAreaErrorReason; private constructor();};
