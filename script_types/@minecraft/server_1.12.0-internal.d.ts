...
//@ts-ignore allow class inheritance for native classes
export class EntityTameableComponent extends EntityComponent{ private constructor(); static readonly componentId: "minecraft:tameable"; readonly probability: number; getTameItems(): ItemStack[]; isTamed(): boolean; tame(player: Player): boolean; tamedToPlayer(): Player; tamedToPlayerId(): string}
//@ts-ignore allow class inheritance for native classes
...
export interface ItemCustomComponent {onBeforeDurabilityDamage?: (arg0: ItemComponentBeforeDurabilityDamageEvent)=>undefined, onCompleteUse?: (arg0: ItemComponentCompleteUseEvent)=>undefined, onHitEntity?: (arg0: ItemComponentHitEntityEvent)=>undefined, onMineBlock?: (arg0: ItemComponentMineBlockEvent)=>undefined, onUse?: (arg0: ItemComponentUseEvent)=>undefined, onUseOn?: (arg0: ItemComponentUseOnEvent)=>undefined}
