...
export enum MemoryTier {High = 4, Low = 2, Mid = 3, SuperHigh = 5, SuperLow = 1, Undetermined = 0}
...
export class ButtonPushAfterEventSignal { private constructor(); subscribe(callback: (arg0: ButtonPushAfterEvent)=>undefined): (arg0: ButtonPushAfterEvent)=>undefined; unsubscribe(callback: (arg0: ButtonPushAfterEvent)=>undefined): void;}
...
//@ts-ignore allow class inheritance for native classes
export class EntityBreathableComponent extends EntityComponent{ private constructor(); static readonly componentId: "minecraft:breathable"; airSupply: number; readonly breathesAir: boolean; readonly breathesLava: boolean; readonly breathesSolids: boolean; readonly breathesWater: boolean; readonly canBreathe: boolean; readonly generatesBubbles: boolean; readonly inhaleTime: number; readonly suffocateTime: number; readonly totalSupply: number; getBreatheBlocks(): BlockPermutation[]; getNonBreatheBlocks(): BlockPermutation[];}
//@ts-ignore allow class inheritance for native classes
...
export class ItemUseOnAfterEvent { private constructor(); readonly block: Block; readonly blockFace: Direction; readonly faceLocation: Vector3; readonly isFirstEvent: boolean; readonly itemStack: ItemStack; readonly source: Player;}
...
export class LeverActionAfterEventSignal { private constructor(); subscribe(callback: (arg0: LeverActionAfterEvent)=>undefined): (arg0: LeverActionAfterEvent)=>undefined; unsubscribe(callback: (arg0: LeverActionAfterEvent)=>undefined): void;}
//@ts-ignore allow class inheritance for native classes
...
export class PlayerInteractWithBlockAfterEvent { private constructor(); readonly beforeItemStack?: ItemStack; readonly block: Block; readonly blockFace: Direction; readonly faceLocation: Vector3; readonly isFirstEvent: boolean; readonly itemStack?: ItemStack; readonly player: Player;}
...
export class PlayerInteractWithBlockBeforeEvent { private constructor(); readonly block: Block; readonly blockFace: Direction; cancel: boolean; readonly faceLocation: Vector3; readonly isFirstEvent: boolean; readonly itemStack?: ItemStack; readonly player: Player;}
...
export class PlayerInteractWithEntityAfterEvent { private constructor(); readonly beforeItemStack?: ItemStack; readonly itemStack?: ItemStack; readonly player: Player; readonly target: Entity;}
...
export class PlayerJoinAfterEventSignal { private constructor(); subscribe(callback: (arg0: PlayerJoinAfterEvent)=>undefined): (arg0: PlayerJoinAfterEvent)=>undefined; unsubscribe(callback: (arg0: PlayerJoinAfterEvent)=>undefined): void;}
export class PlayerLeaveAfterEvent { private constructor(); readonly playerId: string; readonly playerName: string;}
export class PlayerLeaveAfterEventSignal { private constructor(); subscribe(callback: (arg0: PlayerLeaveAfterEvent)=>undefined): (arg0: PlayerLeaveAfterEvent)=>undefined; unsubscribe(callback: (arg0: PlayerLeaveAfterEvent)=>undefined): void;}
...
export class PlayerSpawnAfterEventSignal { private constructor(); subscribe(callback: (arg0: PlayerSpawnAfterEvent)=>undefined): (arg0: PlayerSpawnAfterEvent)=>undefined; unsubscribe(callback: (arg0: PlayerSpawnAfterEvent)=>undefined): void;}
...
export class System { private constructor(); readonly afterEvents: SystemAfterEvents; readonly beforeEvents: SystemBeforeEvents; readonly currentTick: number; readonly serverSystemInfo: SystemInfo; clearJob(jobId: number): void; clearRun(runId: number): void; run(callback: ()=>undefined): number; runInterval(callback: ()=>undefined, tickInterval?: number): number; runJob(generator: Generator<undefined,undefined,undefined>): number; runTimeout(callback: ()=>undefined, tickDelay?: number): number; waitTicks(ticks: number): Promise<undefined>;}
...
export class SystemInfo { private constructor(); readonly memoryTier: MemoryTier;}
//@ts-ignore allow class inheritance for native classes
