...
export class BlockPermutation { private constructor(); static resolve(blockName: string, states?: Record<string,boolean | number | string>): BlockPermutation; getAllStates(): Record<string,boolean | number | string>; getState(stateName: string): boolean | number | string; matches(blockName: string, states?: Record<string,boolean | number | string>): boolean; withState(name: string, value: boolean | number | string): BlockPermutation;}
//@ts-ignore allow class inheritance for native classes
