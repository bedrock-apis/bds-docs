...
export class BlockVolumeBase { private constructor(); getCapacity(): number; getMax(): Vector3; getMin(): Vector3; getSpan(): Vector3; isInside(location: Vector3): boolean; translate(delta: Vector3): void}
//@ts-ignore allow class inheritance for native classes
