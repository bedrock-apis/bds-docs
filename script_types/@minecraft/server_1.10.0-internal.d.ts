...
export class BlockVolumeBase { private constructor(); getBlockLocationIterator(): BlockLocationIterator; getBoundingBox(): BoundingBox; getCapacity(): number; getMax(): Vector3; getMin(): Vector3; getSpan(): Vector3; isInside(pos: Vector3): boolean; translate(delta: Vector3): void}
//@ts-ignore allow class inheritance for native classes
...
export class DataDrivenEntityTriggerBeforeEventSignal { private constructor(); subscribe(callback: (arg0: DataDrivenEntityTriggerBeforeEvent)=>undefined, options?: EntityDataDrivenTriggerEventOptions): (arg0: DataDrivenEntityTriggerBeforeEvent)=>undefined; unsubscribe(callback: (arg0: DataDrivenEntityTriggerBeforeEvent)=>undefined): void}
...
export class StructureManager { private constructor(); createEmpty(identifier: string, size: Vector3, saveMode?: StructureSaveMode): StructureTemplate; createFromWorld(identifier: string, dimension: Dimension, blockVolume: BlockVolume, options?: StructureCreateOptions): StructureTemplate; delete(structure: string | StructureTemplate): boolean; get(identifier: string): StructureTemplate; place(structure: string | StructureTemplate, dimension: Dimension, location: Vector3, options?: StructurePlaceOptions): void}
export class StructureTemplate { private constructor(); readonly id: string}
...
export class Vector { constructor(x: number, y: number, z: number); static readonly back: undefined; static readonly down: undefined; static readonly forward: undefined; static readonly left: undefined; static readonly one: undefined; static readonly right: undefined; static readonly up: undefined; static readonly zero: undefined; static add(a: Vector3, b: Vector3): Vector; static cross(a: Vector3, b: Vector3): Vector; static distance(a: Vector3, b: Vector3): number; static divide(a: Vector3, b: number | Vector3): Vector; static lerp(a: Vector3, b: Vector3, t: number): Vector; static max(a: Vector3, b: Vector3): Vector; static min(a: Vector3, b: Vector3): Vector; static multiply(a: Vector3, b: number | Vector3): Vector; static slerp(a: Vector3, b: Vector3, s: number): Vector; static subtract(a: Vector3, b: Vector3): Vector; x: number; y: number; z: number; equals(other: Vector): boolean; length(): number; lengthSquared(): number; normalized(): Vector}
...
export interface BlockRaycastOptions {blockFilter?: BlockFilter, includeLiquidBlocks?: boolean, includePassableBlocks?: boolean, maxDistance?: number}
