...
export class BrushShape { constructor(name: string, icon: string, rebuild: ()=>_10.CompoundBlockVolume, getSettingsUI: ()=>SettingsUIElement[]); readonly getSettingsUIElements: ()=>SettingsUIElement[]; readonly icon: string; readonly name: string; readonly rebuild: ()=>_10.CompoundBlockVolume}
export class BrushShapeManager { private constructor(); readonly activeBrushShape?: BrushShape; readonly activeBrushVolume?: _10.CompoundBlockVolume; readonly brushShapeNames: string[]; activateBrushShape(name: string): _10.CompoundBlockVolume; getSettingsUIElements(brushName: string): SettingsUIElement[]; registerBrushShape(brushShape: BrushShape): void; uiSettingValueChanged(elementName: string, newValue: boolean | number): void}
...
export class SettingsUIElement { constructor(name: string, initialValue: boolean | number, min?: number, max?: number, valueChanged?: (arg0: boolean | number)=>undefined); readonly initialValue: boolean | number; readonly max?: number; readonly min?: number; readonly name: string; readonly valueChanged?: (arg0: boolean | number)=>undefined}
//@ts-ignore allow class inheritance for native classes
