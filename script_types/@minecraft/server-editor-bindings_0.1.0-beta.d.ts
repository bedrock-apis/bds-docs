...
export class CustomWidget extends Widget{ private constructor(); readonly location: _10.Vector3; readonly rotation: _10.Vector2; readonly showTextOnlyWhenSelected: boolean; getText(): string; setText(text: string): void}
...
export class Widget { private constructor(); readonly valid: boolean; getIsSelected(): boolean; getIsVisible(): boolean; setIsVisible(isVisible: boolean): void}
export class WidgetGroup { private constructor(); readonly valid: boolean; createCustomWidget(customEntityName: string, location: _10.Vector3, rotation?: _10.Vector2, options?: CustomWidgetCreateOptions): CustomWidget; deleteWidget(widgetToDelete: Widget): void; getIsVisible(): boolean; setIsVisible(isVisible: boolean): void}
